...
v.prototype.max;Array.prototype.sum=v.prototype.sum;Array.prototype.average=v.prototype.average;Array.prototype.only=v.prototype.only;Array.prototype.flatten=v.prototype.flatten;Array.prototype.zip=v.prototype.zip;Array.prototype.sorted=v.prototype.sorted;Array.prototype.reversed=v.prototype.reversed;Array.prototype.constructClone=function(a){var b=new this.constructor;b.addEach(a);return b};Array.prototype.has=function(a,b){return-1!==this.findValue(a,b)};Array.prototype.get=function(a){if(+a!==a)throw Error("Indicies must be numbers");
...
l.prototype.has=function(a,b){return!!this.findValue(a,b)};l.prototype.get=function(a,b){var c=this.findValue(a,b);return c?c.value:this.content()};l.prototype["delete"]=function(a,b){var c=this.findLastValue(a,b);return c?(c["delete"](),this.length--,!0):!1};l.prototype.clear=function(){this.head.next=this.head.prev=this.head;this.length=0};l.prototype.add=function(a){this.head.addBefore(new this.Node(a));this.length++;return!0};l.prototype.push=function(){for(var a=this.head,b=0;b<arguments.length;b++){var c=
...
var c=this.getMapChangeDescriptor();(b?c.willChangeListeners:c.changeListeners).push(a);this.dispatchesMapChanges=!0};I.prototype.removeMapChangeListener=function(a,b){var c=this.getMapChangeDescriptor(),c=(b?c.willChangeListeners:c.changeListeners).findLastValue(a);if(!c)throw Error("Can't remove listener: does not exist.");c["delete"]()};I.prototype.dispatchMapChange=function(a,b,c){var d=this.getMapChangeDescriptor(),e="handleMap"+((c?"Will":"")+"Change");(c?d.willChangeListeners:d.changeListeners).forEach(function(c){var d=
