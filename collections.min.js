...
l.prototype.has=function(a,b){return!!this.findValue(a,b)};l.prototype.get=function(a,b){var c=this.findValue(a,b);return c?c.value:this.content()};l.prototype["delete"]=function(a,b){var c=this.findLast(a,b);return c?(c["delete"](),this.length--,!0):!1};l.prototype.clear=function(){this.head.next=this.head.prev=this.head;this.length=0};l.prototype.add=function(a){this.head.addBefore(new this.Node(a));this.length++;return!0};l.prototype.push=function(){for(var a=this.head,b=0;b<arguments.length;b++){var c=
